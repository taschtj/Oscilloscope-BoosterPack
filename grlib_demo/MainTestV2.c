...
Canvas(g_sTop, &g_sBackground, 0, &g_sPushBtn0, &g_sKentec320x240x16_SSD2119,
...
RectangularButton(g_sPushBtn0, &g_sTop, &g_sPushBtn1, 0,
		...
		ClrGray, ClrWhite, ClrRed, ClrRed,g_psFontCm16, "1 V/div", 0, 0,
		0, 0, DRadio0);

RectangularButton(g_sPushBtn1, &g_sTop, 0, 0, &g_sKentec320x240x16_SSD2119,
		53, 0, 52, 28,
		(PB_STYLE_OUTLINE | PB_STYLE_TEXT_OPAQUE | PB_STYLE_TEXT | PB_STYLE_FILL),
		ClrGray, ClrWhite, ClrRed, ClrRed, g_psFontCm16, "1 V/div", 0, 0, 0, 0,
		DRadio1);
Container(g_sContainer0,0,0,&g_sRadioBtn0,&g_sKentec320x240x16_SSD2119,0, 28, 52, 60,(CTR_STYLE_OUTLINE |CTR_STYLE_FILL ),ClrBlack, ClrWhite,ClrRed,g_psFontCm14, "TRY");
Container(g_sContainer1,0,0,&g_sRadioBtn2,&g_sKentec320x240x16_SSD2119,53, 28, 52, 60,(CTR_STYLE_OUTLINE |CTR_STYLE_FILL),ClrBlack, ClrWhite,ClrRed,g_psFontCm14, "TRY");

RadioButton(g_sRadioBtn0,&g_sContainer0,&g_sRadioBtn1,0,&g_sKentec320x240x16_SSD2119,1,40,48,20,(RB_STYLE_FILL|RB_STYLE_OUTLINE|RB_STYLE_SELECTED|RB_STYLE_TEXT),10,ClrBlack,ClrWhite,ClrRed,g_psFontCmss14b,"   111",0,0);
RadioButton(g_sRadioBtn1,&g_sContainer0,0,0,&g_sKentec320x240x16_SSD2119,1,61,48,20,(RB_STYLE_FILL|RB_STYLE_OUTLINE|RB_STYLE_SELECTED|RB_STYLE_TEXT),10,ClrBlack,ClrWhite,ClrRed,g_psFontCmss14b,"   222",0,0);
RadioButton(g_sRadioBtn2,&g_sContainer1,&g_sRadioBtn3,0,&g_sKentec320x240x16_SSD2119,54,40,48,20,(RB_STYLE_FILL|RB_STYLE_OUTLINE|RB_STYLE_SELECTED|RB_STYLE_TEXT),10,ClrBlack,ClrWhite,ClrRed,g_psFontCmss14b,"   111",0,0);
RadioButton(g_sRadioBtn3,&g_sContainer1,0,0,&g_sKentec320x240x16_SSD2119,54,61,48,20,(RB_STYLE_FILL|RB_STYLE_OUTLINE|RB_STYLE_SELECTED|RB_STYLE_TEXT),10,ClrBlack,ClrWhite,ClrRed,g_psFontCmss14b,"   222",0,0);
//
bool HH=false;
