...
RectangularButton(g_sPushBtn, &g_sHeading, 0, &g_sListBox, &g_sKentec320x240x16_SSD2119,
		60, 60, 100, 20,
...
ListBox(g_sListBox, &g_sPushBtn, 0, 0, &g_sKentec320x240x16_SSD2119, 100, 100,
			100, 100, LISTBOX_STYLE_OUTLINE|LISTBOX_STYLE_LOCKED, ClrBlack,
